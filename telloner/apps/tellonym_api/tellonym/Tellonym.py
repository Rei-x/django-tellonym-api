...
class Tellonym:
    ...
    def get_request_token(self, username, password):
        ...
        if 'err' in response:
            ...
            if response['err']['code'] == 'RATELIMIT_REACHED':
    ...
    def send_tell(self, id, text, anonymous=True):
        ...
        Args:
            ...
            anonymous (bool): defines whether the tell is to be sent anonymously or not - defaults to true
